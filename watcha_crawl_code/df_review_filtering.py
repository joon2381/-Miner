...
def filter_spoiler_reviews(MOVIE_TITLE_LIST: list[str], MOVIE_TITLE_EN_LIST: list[str]) -> None :
    """
    Docstring for filter_spoiler_reviews
    
    :param MOVIE_TITLE_LIST: Korean movie titles
    :type MOVIE_TITLE_LIST: list[str]
    :param MOVIE_TITLE_EN_LIST: English movie titles
    :type MOVIE_TITLE_EN_LIST: list[str]
    """
    for MOVIE_TITLE, MOVIE_TITLE_EN in zip(MOVIE_TITLE_LIST, MOVIE_TITLE_EN_LIST) :
        ...
        if spoiler_df.empty :
            print(f"No spoiler reviews remaining in {MOVIE_TITLE} reviews.")
            continue
...
filter_spoiler_reviews(MOVIE_TITLE_LIST, MOVIE_TITLE_EN_LIST)